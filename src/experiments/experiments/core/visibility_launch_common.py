...
def parse_common_launch_config(context) -> Dict[str, object]:
    ...
    cfg: Dict[str, object] = {
        ...
        'localization_cost_mode': str(_launch_value(context, 'localization_cost_mode', PAPER_LAUNCH_DEFAULTS['localization_cost_mode'])),
        'risk_uses_reference_R': _as_bool(_launch_value(context, 'risk_uses_reference_R', PAPER_LAUNCH_DEFAULTS['risk_uses_reference_R'])),
        'route_length_weight': float(_launch_value(context, 'route_length_weight', PAPER_LAUNCH_DEFAULTS['route_length_weight'])),
        'travel_time_weight': float(_launch_value(context, 'travel_time_weight', PAPER_LAUNCH_DEFAULTS['travel_time_weight'])),
        'r_reference_uv': float(_launch_value(context, 'r_reference_uv', PAPER_LAUNCH_DEFAULTS['r_reference_uv'])),
    ...
    if cfg.get('enable_logging', True):
        logger_node = Node(
            ...
            parameters=[{
                ...
                'localization_cost_mode': cfg['localization_cost_mode'],
                'risk_uses_reference_R': cfg['risk_uses_reference_R'],
                'route_length_weight': cfg['route_length_weight'],
                'travel_time_weight': cfg['travel_time_weight'],
                'r_reference_uv': cfg['r_reference_uv'],
