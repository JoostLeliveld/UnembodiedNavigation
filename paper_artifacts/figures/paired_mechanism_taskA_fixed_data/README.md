# paired_mechanism_taskA_fixed source data

This directory contains the exact run files used to generate `paired_mechanism_taskA_fixed.pdf`.

Source campaign: `logs/visibility_comparison/_fixtest_mechanismA`
...
PAIRED_CAMP=_fixtest_mechanismA PAIRED_TASK=route_apron_to_a3_mid PAIRED_SEED=0 \
