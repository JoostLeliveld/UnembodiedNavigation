# paired_mechanism_taskA_current source data

This directory contains the exact run files used to generate `paired_mechanism_taskA_current.pdf`.

Source campaign: `logs/visibility_comparison/paired_mechanism_current_taskA`
...
PAIRED_CAMP=paired_mechanism_current_taskA PAIRED_TASK=route_apron_to_a3_mid PAIRED_SEED=0 \
