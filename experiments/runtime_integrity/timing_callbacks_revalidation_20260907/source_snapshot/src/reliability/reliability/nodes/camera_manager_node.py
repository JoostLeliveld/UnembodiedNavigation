...
class CameraManagerNode(Node):
    ...
    def __init__(self) -> None:
        ...
        self.batch_outcome_pub = self.create_publisher(
            String, "/reliability/camera_manager/batch_outcome", 100
        )
    ...
    def _publish_batch_outcome(self, event) -> None:
        payload = dict(event, schema_version="camera_batch_outcome.v1", stage="manager",
                ...
                if complete is not None:
                    ...
                    if previous is not None and previous != self._last_decided_source_batch_id:
                        self._publish_batch_outcome(dict(
                            source_batch_id=previous, status="superseded_before_decision"))
