...
``experiments/deck_figures/make_camera_views_figure.py``.
...
camera that cannot see the spawn is labelled as such rather than boxed wrongly.
    ...
    python3 experiments/warehouse_v2_sketches/sheet.py <tag> [--spawn X Y]
"""
...
FRAMES = REPO / 'experiments/warehouse_v2_sketches/frames'
