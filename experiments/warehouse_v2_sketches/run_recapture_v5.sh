...
#
# capture_bbox_grid.py refuses unisolated transport for training-grade capture,
...
#
#   bash experiments/warehouse_v2_sketches/run_recapture_v5.sh [out_dir]
...
for attempt in $(seq 1 60); do
  ...
  # capture_bbox_grid.py refuses to write into an existing --out unless
