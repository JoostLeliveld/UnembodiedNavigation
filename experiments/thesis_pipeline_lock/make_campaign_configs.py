...
(amendment 2026-09-23).
    ...
    python3 experiments/thesis_pipeline_lock/make_campaign_configs.py
"""
...
GATE = "config/commissioning_sensor_gate_v3.yaml"
...
def main() -> int:
    ...
    planning_cfg = yaml.safe_load((HERE / "stage09_final_five_seed_campaign.yaml").read_text())
    ...
    execution = yaml.safe_load((HERE / "stage10_final_preselected_campaign.yaml").read_text())
