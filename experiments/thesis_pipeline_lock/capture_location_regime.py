...
MANIFEST = HERE / "camera_capture_map_manifest.json"
...
ROUTE_FILES = {
    name: REPO / f"experiments/fusion_on_fixed_routes/routes/{name}.json"
...
def build_manifest(rows: list[dict], summary: dict) -> dict:
    ...
    return {
        ...
        "sources": {
            ...
            relative(REPO / "experiments/warehouse_v2_sketches/route_tasks.py"): sha256_file(REPO / "experiments/warehouse_v2_sketches/route_tasks.py"),
            relative(REPO / "experiments/warehouse_v2_sketches/coverage.py"): sha256_file(REPO / "experiments/warehouse_v2_sketches/coverage.py"),
        },
    }
