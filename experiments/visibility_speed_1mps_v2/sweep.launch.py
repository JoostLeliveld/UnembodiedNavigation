...
def generate_launch_description():
 ...
 sim=IncludeLaunchDescription(PythonLaunchDescriptionSource(str(Path(get_package_share_directory('sim'))/'launch/bringup_sim.launch.py')),launch_arguments={'world':'warehouse_v2_low_cpu.world.sdf','world_name':'warehouse_v2','headless':'true','reset_world':'false','use_lidar':'false','bridge_scan':'false','bridge_camera_a':'true','bridge_camera_b':'true','bridge_camera_c':'true','bridge_camera_d':'true','bridge_camera_e':'true','bridge_contacts':'true','spawn_x':str(cfg['x']),'spawn_y':str(cfg['y']),'spawn_z':'0.01','spawn_yaw':str(cfg['yaw'])}.items())
