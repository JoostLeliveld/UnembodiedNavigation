...
**Implementation follow-up, 2026-09-07:** the subsequently authorized mission/route repairs and their 236-test component result are recorded in [09_mission_route_repairs.md](09_mission_route_repairs.md). The ranked findings and “current” labels below describe the retained pre-implementation snapshots. Their historical source/evidence has not been rewritten to match the later repairs.

Audited 2026-09-06, revalidated 2026-09-07 after repair packages `5e844a89` and `f9e1a312`. **The recorded corner failure is reproducible without camera error. The corrected-runtime stop short of the goal is consistent with a local clearance refusal, with waypoints remaining. Invalid belief data can still declare success, changed goals can leave obsolete routes/tapes installed, and experiment completion does not verify physical rest.** Ordinary-stop cancellation and installation-age checks are now repaired. The typed safety gate rejects NaN clearance, but its renewable 5 mm allowance still permits cumulative penetration.
...
Priority reflects consequence and reachability, not estimated frequency. “Current” refers to the September 7 revalidation snapshot below. The 50-case September 6 packet is retained as baseline evidence. Conditional input failures are not attributed to recorded pilots without evidence.

| Rank / ID | Classification and reachability | Finding | Smallest repair |
|---|---|---|---|
| 1 / T09-01 / P1 | Confirmed current; active simple tracker, conditional on a boundary excursion | The 5 mm allowance renews on every replan, permitting cumulative penetration. NaN/negative-infinity acceptance is repaired | Require non-worsening recovery against a persistent bound |
...
| 3 / T09-03 / P1 | Confirmed current goal/belief defect; ordinary-stop cancellation repaired; goal changes dormant in the fixed single-goal pilot | Old goal/belief context can install or continue a tape; moves of at most 1 m do not replace the global goal | Add goal revision and belief revalidation to the existing installation transaction |
...
The configuration table describes the registered corrected-runtime pilot and its separate recovery follow-up. It does not assign those runs to later cache, GPU or fast-run configurations. Completed audits 12–14 and `WRITING_STYLE.md` were also checked during final QA. Detailed finding and terminal-matrix source references point to [hash-verified September 6 source copies](09_tracking_evidence/baseline_source/manifest.json), so subsequent edits cannot move the referenced code. The September 7 source map below identifies the revalidated paths. No historical drive or baseline assertion was rewritten to match a repair.

### September 7 repair revalidation

[09_current_revalidation.py](09_current_revalidation.py) ran **35 deterministic cases** against current production methods. [Results and exact source hashes](09_tracking_evidence/post_repair/results.json) are retained with source copies. The current EFE hash is `f3750f4a4dcb…`, mission `deedad91515c4…`, logger `10c57ede5d42…`. The source hash set remained unchanged during the probe. These fixtures control scheduling and transport; they do not establish physical braking or complete ROS integration.

| Boundary | Revalidated result | Current source in the retained snapshot |
|---|---|---|
| Ordinary stop during local computation | One zero publication, no installed tape. The pre-repair nonzero resumption is fixed | [EFE request/install :617](09_tracking_evidence/post_repair/source_snapshot/src/planning/planning/nodes/efe_agent_node.py:617), stop :1520 |
| Installation age | One .25 s control accepted at .25 s and refused at .2501 s. Existing direct/local package tests also pass | [EFE :630](09_tracking_evidence/post_repair/source_snapshot/src/planning/planning/nodes/efe_agent_node.py:630) |
| Typed geometry result | NaN and negative infinity refuse at step zero with `invalid_geometry`. Positive infinity retains the empty-scene meaning | [EFE :1267](09_tracking_evidence/post_repair/source_snapshot/src/planning/planning/nodes/efe_agent_node.py:1267) |
| Renewable recovery allowance | Still increases modeled penetration from .001 to .132859 m over 30 accepted prefixes | Same gate at :1305–1327 |
| Invalid operational belief | Stale/wrong-frame/invalid-covariance goal success and mission readiness/advancement persist | [Mission :87](09_tracking_evidence/post_repair/source_snapshot/src/experiments/experiments/nodes/goal_mission_node.py:87), [logger :2232](09_tracking_evidence/post_repair/source_snapshot/src/experiments/experiments/nodes/experiment_logger.py:2232) |
| Goal and belief changes | Local stale tapes, active-tape continuation and <=1 m goal threshold persist. An invalid global result still installs after goal/belief changes | [EFE :730](09_tracking_evidence/post_repair/source_snapshot/src/planning/planning/nodes/efe_agent_node.py:730), GLOBAL :951–1012; [base goal :1019](09_tracking_evidence/post_repair/source_snapshot/src/planning/planning/nodes/unicycle_planner_node.py:1019) |
| Goal hold and stuck | A new goal inherits the old hold. Rotation, idle replanning and stale XY still yield `stuck` | [Logger :1494](09_tracking_evidence/post_repair/source_snapshot/src/experiments/experiments/nodes/experiment_logger.py:1494), :1541, :1776 |
| Summary versus stop | Logger completes while another nonzero tape publication remains possible | [Logger :3248](09_tracking_evidence/post_repair/source_snapshot/src/experiments/experiments/nodes/experiment_logger.py:3248) |
| Mission traffic/time | Current mission suppresses unchanged goal repeats by default. Goal stamps still use system time; readiness semantics are unchanged | [Mission :118](09_tracking_evidence/post_repair/source_snapshot/src/experiments/experiments/nodes/goal_mission_node.py:118) |

The current component packet passed **139 tests**, including both repair packages' relevant state/command tests, typed tracker guard, mission traffic, routes, logger alignment and watchdog. [Exact output](09_tracking_evidence/post_repair_tests.txt). Package A's immutable motion/envelope/odometry repairs are acknowledged; they do not add a validity gate to mission/logger consumers. Package B's stop generation and age gate are acknowledged; they do not add goal or belief revision ownership. This audit does not claim another complete navigation trial after those packages.
...
Defaults and wiring: [visibility_launch_common.py:122](/home/joostleliveld/Thesis/UnembodiedNavigation/docs/module_audits/09_tracking_evidence/baseline_source/src/experiments/experiments/core/visibility_launch_common.py:122), mission at :1291, logger at :1331, planner at :1923. The unplumbed node-only goal threshold is [efe_agent_node.py:356](/home/joostleliveld/Thesis/UnembodiedNavigation/docs/module_audits/09_tracking_evidence/baseline_source/src/planning/planning/nodes/efe_agent_node.py:356).
...
**Smallest repair:** use a non-worsening persistent reference for recovery, with a numerical tolerance that cannot accumulate as permission to move inward. Distinguish physical collision from a lane-standoff preference. Retain the new invalid-geometry rejection and the explicit positive-infinity empty-scene convention. Any change to the intended standoff or permitted penetration policy requires its own configuration/protocol change.

### T09-02 — Operational belief is consumed without a shared validity gate

**Sources:** [goal_mission_node.py:81](/home/joostleliveld/Thesis/UnembodiedNavigation/docs/module_audits/09_tracking_evidence/baseline_source/src/experiments/experiments/nodes/goal_mission_node.py:81), :98–109; [experiment_logger.py:2240](/home/joostleliveld/Thesis/UnembodiedNavigation/docs/module_audits/09_tracking_evidence/baseline_source/src/experiments/experiments/nodes/experiment_logger.py:2240), :2489–2506, :2774–2805, :1502–1579; [efe_agent_node.py:610](/home/joostleliveld/Thesis/UnembodiedNavigation/docs/module_audits/09_tracking_evidence/baseline_source/src/planning/planning/nodes/efe_agent_node.py:610). The inherited frame check is at [unicycle_planner_node.py:2980](/home/joostleliveld/Thesis/UnembodiedNavigation/docs/module_audits/09_tracking_evidence/baseline_source/src/planning/planning/nodes/unicycle_planner_node.py:2980); the hierarchical override bypasses it.
...
**Sources:** [efe_agent_node.py:624](/home/joostleliveld/Thesis/UnembodiedNavigation/docs/module_audits/09_tracking_evidence/baseline_source/src/planning/planning/nodes/efe_agent_node.py:624), :827–887, :939–965, :1223–1379; [unicycle_planner_node.py:1002](/home/joostleliveld/Thesis/UnembodiedNavigation/docs/module_audits/09_tracking_evidence/baseline_source/src/planning/planning/nodes/unicycle_planner_node.py:1002); [experiment_logger.py:1784](/home/joostleliveld/Thesis/UnembodiedNavigation/docs/module_audits/09_tracking_evidence/baseline_source/src/experiments/experiments/nodes/experiment_logger.py:1784).
...
During local computation, changing the goal or flipping the belief heading by π still permits publication of the pre-change `(0.22,0)` tape. In the baseline, an ordinary safe stop during computation published zero and was followed by nonzero publication. Package B now cancels that result; the current probe observes only zero and no tape. Fatal stop remains latched. A belief change after installation also leaves the next timer publication on the old tape.
...
**Smallest repair:** add canonical goal identity/revision and an explicit belief/epoch policy to the existing request/installation boundary. Keep the implemented stop generation and age checks. Reset mission-progress history on a genuine goal change, without resetting it for an unchanged goal if republishing is enabled. Coordinate with 03 and GLOBAL validation with 08. Do not discard every routine belief update indiscriminately: define which corrections require rerolling/revalidating the remaining controls so continuous updates do not starve planning. The fixed single-goal pilots do not demonstrate a live goal-change race.

### T09-04 — A terminal decision is not a verified physical stop

**Sources:** [efe_agent_node.py:952](/home/joostleliveld/Thesis/UnembodiedNavigation/docs/module_audits/09_tracking_evidence/baseline_source/src/planning/planning/nodes/efe_agent_node.py:952), :989, :1297–1302, :1371; [actuation_noise_node.py:190](/home/joostleliveld/Thesis/UnembodiedNavigation/docs/module_audits/09_tracking_evidence/baseline_source/src/sim/sim/actuation_noise_node.py:190); [experiment_logger.py:3256](/home/joostleliveld/Thesis/UnembodiedNavigation/docs/module_audits/09_tracking_evidence/baseline_source/src/experiments/experiments/nodes/experiment_logger.py:3256), :3394–3504; launch :1337.
...
**Sources:** [efe_agent_node.py:827](/home/joostleliveld/Thesis/UnembodiedNavigation/docs/module_audits/09_tracking_evidence/baseline_source/src/planning/planning/nodes/efe_agent_node.py:827), :848–887; [base_planner.py:324](/home/joostleliveld/Thesis/UnembodiedNavigation/docs/module_audits/09_tracking_evidence/baseline_source/src/planning/planning/planners/base_planner.py:324). Full solver evidence and ownership: [audit 08, P08-01/02](08_planner_and_future_camera_model.md).
...
**Sources:** [base_planner.py:55](/home/joostleliveld/Thesis/UnembodiedNavigation/docs/module_audits/09_tracking_evidence/baseline_source/src/planning/planning/planners/base_planner.py:55); [efe_agent_node.py:893](/home/joostleliveld/Thesis/UnembodiedNavigation/docs/module_audits/09_tracking_evidence/baseline_source/src/planning/planning/nodes/efe_agent_node.py:893), :969–1001, :1044–1067; [preselected_route.py:91](/home/joostleliveld/Thesis/UnembodiedNavigation/docs/module_audits/09_tracking_evidence/baseline_source/src/unav_common/unav_common/preselected_route.py:91), :205–299; [lane_graph_routes.py:70](/home/joostleliveld/Thesis/UnembodiedNavigation/docs/module_audits/09_tracking_evidence/baseline_source/src/unav_common/unav_common/lane_graph_routes.py:70).
...
**Source:** [experiment_logger.py:1431](/home/joostleliveld/Thesis/UnembodiedNavigation/docs/module_audits/09_tracking_evidence/baseline_source/src/experiments/experiments/nodes/experiment_logger.py:1431), :1472–1489, :1549–1579. Motion history contains logger time, XY, goal distance and binary command activity; no heading or controller phase.
...
**Sources:** [experiment_logger.py:1985](/home/joostleliveld/Thesis/UnembodiedNavigation/docs/module_audits/09_tracking_evidence/baseline_source/src/experiments/experiments/nodes/experiment_logger.py:1985), :2978–3017, :3231–3237, :3381–3387; [run_visibility_campaign.py:1472](/home/joostleliveld/Thesis/UnembodiedNavigation/docs/module_audits/09_tracking_evidence/baseline_source/scripts/visibility_comparison/run_visibility_campaign.py:1472). See [10, L10-11](10_logging_and_event_accounting.md).
...
**Completed simulator audit qualification:** [14, S14-01/03](14_simulator_world_and_physical_outcomes.md) identifies five physical props omitted from planner collision JSON and contact instrumentation. Its independent mesh check puts the registered route's configured circle 0.028456 m inside the omitted pallet-jack clearance. This is separate from the observed `obs_A2b3e` contacts and the ideal-motion corner refusal. All body-clearance numbers in this report refer to the planner's declared geometry, not certification of the complete physical scene. Audit 14 also demonstrates continued motion after clock-bridge or adapter loss in private physics fixtures. The 0.5 s adapter watchdog therefore depends on its process and advancing simulation clock; it is not an unconditional physical-stop guarantee.

### T09-09 — Mission clock domain and readiness are inconsistent

**Source:** [goal_mission_node.py:69](/home/joostleliveld/Thesis/UnembodiedNavigation/docs/module_audits/09_tracking_evidence/baseline_source/src/experiments/experiments/nodes/goal_mission_node.py:69), :113–140; launch :1291–1302.
...
**Source:** [lane_graph_routes.py:162](/home/joostleliveld/Thesis/UnembodiedNavigation/docs/module_audits/09_tracking_evidence/baseline_source/src/unav_common/unav_common/lane_graph_routes.py:162). Corridors are split using `y<0` and `y>0`, omitting `y=0`.
...
The read-only [09_ideal_replay.py](09_ideal_replay.py) uses the recorded P0 route/settings, retained original controller source and `tracker_preflight.py`. The retained old source hash `688484713982…` matches the original recorded P0 preflight source hash. The September 6 replay EFE hash is `a575ba53e74a…`; these saved trajectories were not regenerated with the later packages. Full hashes, trajectories, commands and gate reasons are in [ideal_replay.json](09_tracking_evidence/ideal_replay.json).
...
| Sept. 6 repaired runtime / 1.0 / .35 | Same corner refusal | 77.00 s | 16 / 17.481 m |
| Sept. 6 repaired runtime / .20 / .10 | Enters existing goal region | 170.75 s | 168 / .320 m |
| Sept. 6 repaired runtime / .20 / .05 | Enters existing goal region | 172.75 s | 168 / .323 m |
...
| Ordinary explicit safe stop / fatal latch | Publication clock and in-memory ownership; fatal latch prevents subsequent nonzero publication | Baseline stale installation is repaired by package B. Fatal teardown may yield interrupted/no summary rather than the synthetic surviving-logger `stuck` |
...
- [09_tracking_probe.py](09_tracking_probe.py), [50-case baseline results](09_tracking_evidence/probes_current/probe_results.json) and [console output](09_tracking_evidence/probe_current_output.txt): real callbacks/controllers with controlled clocks, publishers, solve boundaries and belief inputs; real summary writer; unchanged AST-extracted logger distance/dispatch statements. This baseline intentionally asserts behaviors since repaired and is not a current acceptance command.
- [09_current_revalidation.py](09_current_revalidation.py) and [35-case post-repair results](09_tracking_evidence/post_repair/results.json): current ordinary/fatal stop, age, typed geometry, remaining belief/goal/route and terminal cases. Current source bytes are retained beside the result.
...
- [Baseline regressions](09_tracking_evidence/current_regressions.txt): **55 passed**. [Post-repair regressions](09_tracking_evidence/post_repair_tests.txt): **139 passed**. Audit scripts compile. Older `probes`, `probes_final`, `runs` and `runs_final` directories are intermediate audit outputs, not additional experiment selections.

Recheck the current source without launching ROS/Gazebo or modifying a recorded experiment, from the repository root. The saved ideal-motion and 50-case baseline outputs retain their own hashes; do not relabel a rerun against newer source as the original runtime.

```bash
audit09_out=$(mktemp -d /tmp/unav_audit09.XXXXXX)
OPENBLAS_NUM_THREADS=1 OMP_NUM_THREADS=1 python3 docs/module_audits/09_current_revalidation.py --out "$audit09_out/revalidation"
...
OPENBLAS_NUM_THREADS=1 OMP_NUM_THREADS=1 python3 -m pytest -q tests/planning/test_command_installation.py tests/planning/test_runtime_transactions.py tests/planning/test_tracker_guard.py tests/planning/test_outage_motion_replay.py tests/planning/test_planner_node_state_correction.py tests/sim/test_encoder_input_chronology.py tests/planning/test_lane_graph_routes.py tests/planning/test_preselected_route.py tests/experiments/test_logger_time_alignment.py tests/experiments/test_goal_mission_traffic.py tests/sim/test_command_watchdog.py
```

**Documented repairs, not newly open bugs:** verified full supported-motion replay; serialized state and command transactions; shared prediction/publication timestamp; angular-limit correction for the active simple tracker; envelope validation; per-camera deduplication; finite tape expiry; adapter watchdog; later fatal publication latch, negative tape-age guard and idle diagnostics. The 55-test packet rechecks its relevant subset; it does not replay every archived defect. Older command-timer races must not be presented as unfixed when their specific regression is now covered. Ordinary-stop generation and installation age are now repaired by package B. Changed-goal/belief installation remains open. The checked rotation option is implemented and has a separately registered live branch check. Its current typed gate rejects invalid geometry but retains T09-01's renewable allowance.
