# paired_mechanism_west_lowlat source data

This directory contains the exact run files used to generate `paired_mechanism_west_lowlat.pdf`.

Source campaign: `logs/visibility_comparison/honest_campaign_v1`

Task: `route_west_to_a1_upper`, seed: `1`

Regenerate the figure with:

```bash
cd /home/joostleliveld/Thesis/UnembodiedNavigation
PAIRED_CAMP=honest_campaign_v1 PAIRED_TASK=route_west_to_a1_upper PAIRED_SEED=1 \
